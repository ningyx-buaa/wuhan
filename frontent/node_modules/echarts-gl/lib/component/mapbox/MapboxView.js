...
var displayShadowGLSL = require("../../util/shader/displayShadow.glsl.js");
...
var _default = echarts.extendComponentView({
  ...
  render: function (mapboxModel, ecModel, api) {
    ...
    var coordSys = mapboxModel.coordinateSystem; // Not add to rootNode. Or light direction will be stretched by rootNode scale
    ...
    this._sceneHelper.updateLight(mapboxModel); // Update post effects
  ...
  afterRender: function (mapboxModel, ecModel, api, layerGL) {
    ...
    this._sceneHelper.updateSkybox(renderer, mapboxModel, api); // FIXME If other series changes coordinate system.
