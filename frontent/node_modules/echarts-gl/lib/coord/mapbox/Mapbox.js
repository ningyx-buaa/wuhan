...
Mapbox.prototype = {
  ...
  updateTransform: function () {
    ...
    var pitch = Math.max(Math.min(this.pitch, 60), 0) / 180 * Math.PI; // Find the distance from the center point [width/2, height/2] to the
    ...
    var farZ = furthestDistance * 1.1; // matrix for conversion from location to GL coordinates (-1 .. 1)
