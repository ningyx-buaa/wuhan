...
var SphereGeometry = require("qtek/lib/geometry/Sphere");

var PlaneGeometry = require("qtek/lib/geometry/Plane");

var CubeGeometry = require("qtek/lib/geometry/Cube");

var AmbientLight = require("qtek/lib/light/Ambient");

var DirectionalLight = require("qtek/lib/light/Directional");

var PointLight = require("qtek/lib/light/Point");

var SpotLight = require("qtek/lib/light/Spot");
...
var Matrix2 = require("qtek/lib/math/Matrix2");

var Matrix2d = require("qtek/lib/math/Matrix2d");

var Matrix3 = require("qtek/lib/math/Matrix3");

var Matrix4 = require("qtek/lib/math/Matrix4");

var Plane = require("qtek/lib/math/Plane");

var Ray = require("qtek/lib/math/Ray");

var BoundingBox = require("qtek/lib/math/BoundingBox");

var Frustum = require("qtek/lib/math/Frustum");

var animatableMixin = require("./animatableMixin");

var utilGLSL = require("qtek/lib/shader/source/util.glsl.js");

var prezGLSL = require("qtek/lib/shader/source/prez.glsl.js");

var commonGLSL = require("./shader/common.glsl.js");

var colorGLSL = require("./shader/color.glsl.js");

var lambertGLSL = require("./shader/lambert.glsl.js");

var realisticGLSL = require("./shader/realistic.glsl.js");

var hatchingGLSL = require("./shader/hatching.glsl.js");

var shadowGLSL = require("./shader/shadow.glsl.js");
...
Material.prototype.setTextureImage = function (textureName, imgValue, api, textureOpts) {
  ...
  var zr = api.getZr();
  var material = this;
  var texture; // disableTexture first
