...
var vectorFieldParticleGLSL = require("./vectorFieldParticle.glsl.js");
...
VectorFieldParticleSurface.prototype = {
  ...
  getSurfaceTexture: function () {
    var downsampleTextures = this._downsampleTextures;
    return downsampleTextures.length > 0 ? downsampleTextures[downsampleTextures.length - 1] : this._thisFrameTexture;
  },
...
var _default = VectorFieldParticleSurface;
