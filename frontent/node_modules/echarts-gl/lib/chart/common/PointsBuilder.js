...
PointsBuilder.prototype = {
  ...
  update: function (seriesModel, ecModel, api) {
    ...
    var itemStyle = seriesModel.getModel('itemStyle').getItemStyle(); // In case invalid data.
    ...
    for (var i = 0; i < data.count(); i++) {
      ...
      rgbaArr[3] *= opacity; // Save the original opacity for recover from fadeIn.
  ...
  _setPositionTextureToMesh: function (mesh, texture) {
    ...
    mesh.material.shader[texture ? 'enableTexture' : 'disableTexture']('positionTexture');
  },
