...
var forceAtlas2Code = require("./forceAtlas2.glsl.js");
...
ForceAtlas2GPU.prototype.step = function (renderer) {
  ...
  renderer.renderQueue([edgeForceMesh], this._dummyCamera); // Calc weighted sum.
  ...
  renderer.renderQueue([weightedSumMesh], this._dummyCamera); // Calc global speed.
...
ForceAtlas2GPU.prototype.isFinished = function (renderer, threshold) {
  ...
  var globalSpeedData = this.getTextureData(renderer, 'globalSpeed'); // console.log(globalSpeedData[0]);
  // PENDING
