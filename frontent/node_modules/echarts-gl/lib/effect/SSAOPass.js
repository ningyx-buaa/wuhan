...
var SSAOGLSL = require("./SSAO.glsl.js");
...
SSAOPass.prototype.setNormalTexture = function (normalTex) {
  ...
  this._ssaoPass.material.shader[normalTex ? 'enableTexture' : 'disableTexture']('normalTex'); // Switch between hemisphere and shere kernel.
