...
var normalGLSL = require("../util/shader/normal.glsl.js");
...
NormalPass.prototype.update = function (renderer, scene, camera) {
  ...
  renderer.beforeRenderObject = getBeforeRenderHook(renderer.gl, this._defaultNormalMap, this._defaultBumpMap, this._defaultRoughessMap, this._normalMaterial);
