...
<html lang="en">
<head>
    <title>Code coverage report for src/light/Sphere.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/light/</a> Sphere.js
    </h1>
    <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >                return instance.getWorldPosition()._array;</span>
            }
        },
        sphereLightRange: {
            type: '1f',
...
<span class="cstat-no" title="statement not covered" >                return instance.range;</span>
        ...
        sphereLightRadius: {
            type: '1f',
            value: function(instance) <span class="fstat-no" title="function not covered" >{</span>
<span class="cstat-no" title="statement not covered" >                return instance.radius;</span>
            }
        },
        sphereLightColor: {
            type: '3f',
