...
<html lang="en">
<head>
    <title>Code coverage report for src/light/AmbientCubemap.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/light/</a> AmbientCubemap.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// https://docs.unrealengine.com/latest/INT/Engine/Rendering/LightingAndShadows/AmbientCubemap/
...
&nbsp;
    prefilter: function (renderer, size) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!this._brdfLookup) {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (cubemap.__prefiltered) {
