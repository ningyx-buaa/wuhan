...
<div class='wrapper'>
  <div class='pad1'>
    ...
    <div class='clearfix'>
      ...
      <div class='fl pad1y space-right2'>
        <span class="strong">69.74% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>53/76</span>
      </div>
      <div class='fl pad1y space-right2'>
...
448
449
450</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
    ...
    render: function (renderer, shader) {
        ...
        var shader = shader || <span class="branch-1 cbranch-no" title="branch not covered" >this.material.shader;</span>
...
&nbsp;
        ...
        var indicesType = useUintExt ? <span class="branch-0 cbranch-no" title="branch not covered" >_gl.UNSIGNED_INT </span>: _gl.UNSIGNED_SHORT;
&nbsp;
...
&nbsp;
        if (currentDrawID !== prevDrawID) {
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if (
                ((nVertex &gt; 0xffff &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >!uintExt)</span> &amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >isUseIndices)</span>
                || (vaoExt &amp;&amp; isStatic)
                || <span class="branch-5 cbranch-no" title="branch not covered" >geometry._cache.isDirty()</span>
            ) {
                drawHashChanged = true;
            }
        }
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!drawHashChanged) {
            // Direct draw
<span class="cstat-no" title="statement not covered" >            if (prevDrawIsUseIndices) {</span>
<span class="cstat-no" title="statement not covered" >                _gl.drawElements(glDrawMode, prevDrawIndicesBuffer.count, indicesType, 0);</span>
<span class="cstat-no" title="statement not covered" >                renderInfo.triangleCount = prevDrawIndicesBuffer.count / 3;</span>
            }
            else {
                // FIXME Use vertex number in buffer
                // vertexCount may get the wrong value when geometry forget to mark dirty after update
<span class="cstat-no" title="statement not covered" >                _gl.drawArrays(glDrawMode, 0, nVertex);</span>
            }
<span class="cstat-no" title="statement not covered" >            renderInfo.drawCallCount = 1;</span>
        }
        else {
            ...
            if (!vaoList) {
                ...
                <span class="missing-if-branch" title="if path not taken" >I</span>if (!chunks) {  // Empty mesh
...
&nbsp;
                    ...
                    for (var a = 0; a &lt; attributeBuffers.length; a++) {
                        ...
                        var symbol;
                        <span class="missing-if-branch" title="else path not taken" >E</span>if (semantic) {
                            var semanticInfo = shader.attribSemantics[semantic];
                            symbol = semanticInfo &amp;&amp; semanticInfo.symbol;
                        }
                        else {
<span class="cstat-no" title="statement not covered" >                            symbol = name;</span>
                        }
...
&nbsp;
                ...
                <span class="missing-if-branch" title="else path not taken" >E</span>if (isStatic) {
...
&nbsp;
                ...
                <span class="missing-if-branch" title="else path not taken" >E</span>if (vaoExt &amp;&amp; isStatic) {
                    ...
                    for (var a = 0; a &lt; availableAttributes.length; a++) {
                        ...
                        switch (attributeBufferInfo.type) {
                            case 'float':
                                glType = _gl.FLOAT;
                                break;
<span class="branch-1 cbranch-no" title="branch not covered" >                            case 'byte':</span>
<span class="cstat-no" title="statement not covered" >                                glType = _gl.BYTE;</span>
<span class="cstat-no" title="statement not covered" >                                break;</span>
<span class="branch-2 cbranch-no" title="branch not covered" >                            case 'ubyte':</span>
<span class="cstat-no" title="statement not covered" >                                glType = _gl.UNSIGNED_BYTE;</span>
<span class="cstat-no" title="statement not covered" >                                break;</span>
<span class="branch-3 cbranch-no" title="branch not covered" >                            case 'short':</span>
<span class="cstat-no" title="statement not covered" >                                glType = _gl.SHORT;</span>
<span class="cstat-no" title="statement not covered" >                                break;</span>
<span class="branch-4 cbranch-no" title="branch not covered" >                            case 'ushort':</span>
<span class="cstat-no" title="statement not covered" >                                glType = _gl.UNSIGNED_SHORT;</span>
<span class="cstat-no" title="statement not covered" >                                break;</span>
<span class="branch-5 cbranch-no" title="branch not covered" >                            default:</span>
<span class="cstat-no" title="statement not covered" >                                glType = _gl.FLOAT;</span>
<span class="cstat-no" title="statement not covered" >                                break;</span>
                        }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                    _gl.lineWidth(this.lineWidth);</span>
                }
&nbsp;
                prevDrawIndicesBuffer = indicesBuffer;
                prevDrawIsUseIndices = geometry.isUseIndices();
                // Do drawing
                <span class="missing-if-branch" title="else path not taken" >E</span>if (prevDrawIsUseIndices) {
                    if (needsBindAttributes) {
