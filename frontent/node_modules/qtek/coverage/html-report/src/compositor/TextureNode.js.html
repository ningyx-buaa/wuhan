 ...
 */
var TextureNode = Node.extend(function() <span class="fstat-no" title="function not covered" >{</span>
<span class="cstat-no" title="statement not covered" >    return /** @lends qtek.compositor.TextureNode# */ {</span>
        /**
         * @type {qtek.Texture2D}
         */
        texture: null,
