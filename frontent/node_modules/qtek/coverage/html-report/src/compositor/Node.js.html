...
<span class="cstat-no" title="statement not covered" >    return /** @lends qtek.compositor.Node# */ {</span>
        /**
         * @type {string}
         */
        name: '',
...
&nbsp;
        ...
        var shader = <span class="cstat-no" title="statement not covered" >this.pass.material.shader;</span>
<span class="cstat-no" title="statement not covered" >        shader.enableTexture(inputPinName);</span>
    },
&nbsp;
