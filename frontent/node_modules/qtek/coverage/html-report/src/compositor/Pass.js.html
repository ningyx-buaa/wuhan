...
/** @lends qtek.compositor.Pass.prototype */
{
    ...
    setUniform : function(name, value) {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (uniform) {
            uniform.value = value;
        }
    },
    /**
...
<span class="cstat-no" title="statement not covered" >        this.material.dispose(renderer);</span>
    }
});
&nbsp;
export default Pass;
