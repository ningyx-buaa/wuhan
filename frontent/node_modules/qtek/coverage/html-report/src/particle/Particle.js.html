...
<span class="cstat-no" title="statement not covered" >        vec3.scaleAndAdd(this.position._array, this.position._array, this.velocity._array, deltaTime);</span>
    }
<span class="cstat-no" title="statement not covered" >    if (this.angularVelocity) {</span>
<span class="cstat-no" title="statement not covered" >        vec3.scaleAndAdd(this.rotation._array, this.rotation._array, this.angularVelocity._array, deltaTime);</span>
    }
};
&nbsp;
