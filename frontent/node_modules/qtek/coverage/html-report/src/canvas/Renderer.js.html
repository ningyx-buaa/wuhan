...
&nbsp;
        var opaqueQueue = <span class="cstat-no" title="statement not covered" >scene.opaqueQueue;</span>
        var transparentQueue = <span class="cstat-no" title="statement not covered" >scene.transparentQueue;</span>
        var sceneMaterial = scene.material;
&nbsp;
        var queue = <span class="cstat-no" title="statement not covered" >opaqueQueue.concat(transparentQueue);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        this.renderQueue(queue, camera);</span>
    },
&nbsp;
    renderQueue: function (queue, camera) <span class="fstat-no" title="function not covered" >{</span>
        var viewProj = <span class="cstat-no" title="statement not covered" >mat4.create();</span>
<span class="cstat-no" title="statement not covered" >        mat4.multiply(viewProj, camera.projectionMatrix._array, camera.viewMatrix._array);</span>
...
<span class="cstat-no" title="statement not covered" >        for (var i = 0; i &lt; queue.length; i++) {</span>
            var renderable = <span class="cstat-no" title="statement not covered" >queue[i];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            mat4.multiply(worldViewProjMat, viewProj, renderable.worldTransform._array);</span>
&nbsp;
