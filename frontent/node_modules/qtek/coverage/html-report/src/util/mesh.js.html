...
&nbsp;
            var matrix = <span class="cstat-no" title="statement not covered" >applyWorldTransform ? mesh.worldTransform._array : mesh.localTransform._array;</span>
...
&nbsp;
    ...
    splitByJoints: function (mesh, maxJointNumber, inPlace, shaderLib, shaderType) <span class="fstat-no" title="function not covered" >{</span>
        ...
        var shader = <span class="cstat-no" title="statement not covered" >material.shader;</span>
...
&nbsp;
        var shaders = <span class="cstat-no" title="statement not covered" >{};</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >            if (material instanceof StandardMaterial) {</span>
<span class="cstat-no" title="statement not covered" >                subMat.jointCount = subJointNumber;</span>
            }
            else {
                var subShader;
<span class="cstat-no" title="statement not covered" >                if (shaderLib &amp;&amp; shaderType) {</span>
                    var vertexDefines = <span class="cstat-no" title="statement not covered" >{};</span>
<span class="cstat-no" title="statement not covered" >                    for (var name in shader.vertexDefines) {</span>
<span class="cstat-no" title="statement not covered" >                        vertexDefines[name] = shader.vertexDefines[name];</span>
                    }
<span class="cstat-no" title="statement not covered" >                    vertexDefines.JOINT_COUNT = subJointNumber;</span>
<span class="cstat-no" title="statement not covered" >                    subShader = shaderLib.get(shaderType, {</span>
...
<span class="cstat-no" title="statement not covered" >                    subShader = shaders[subJointNumber];</span>
<span class="cstat-no" title="statement not covered" >                    if (!subShader) {</span>
<span class="cstat-no" title="statement not covered" >                        subShader = shader.clone();</span>
<span class="cstat-no" title="statement not covered" >                        subShader.define('vertex', 'JOINT_COUNT', subJointNumber);</span>
<span class="cstat-no" title="statement not covered" >                        shaders[subJointNumber] = subShader;</span>
                    }
                }
<span class="cstat-no" title="statement not covered" >                subMat.attachShader(subShader, true);</span>
            }
