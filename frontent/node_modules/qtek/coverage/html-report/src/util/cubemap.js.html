...
&nbsp;
    ...
    textureOpts.decodeRGBM &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >prefilterMaterial.shader.define('fragment', 'RGBM_DECODE');</span>
&nbsp;
    var dummyScene = new Scene();
    var skyEnv;
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (envMap instanceof Texture2D) {
