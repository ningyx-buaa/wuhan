...
<span class="cstat-no" title="statement not covered" >    if (envMap instanceof Texture2D) {</span>
...
<span class="cstat-no" title="statement not covered" >    skybox.material.shader.define('fragment', 'RGBM_ENCODE');</span>
<span class="cstat-no" title="statement not covered" >    if (opts.decodeRGBM) {</span>
<span class="cstat-no" title="statement not covered" >        skybox.material.shader.define('fragment', 'RGBM_DECODE');</span>
    }
