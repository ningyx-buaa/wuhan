  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>5/471</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>5/467</span>
      </div>
    </div>
  </div>
...
&nbsp;
        var shaderLib = <span class="cstat-no" title="statement not covered" >this.shaderLibrary;</span>
        var shaderName = <span class="cstat-no" title="statement not covered" >this.shaderName;</span>
...
<span class="cstat-no" title="statement not covered" >            mesh.joints = jointIndices;</span>
            ...
            var originalShader = <span class="cstat-no" title="statement not covered" >mesh.material.shader;</span>
            var material = <span class="cstat-no" title="statement not covered" >mesh.material.clone();</span>
<span class="cstat-no" title="statement not covered" >            mesh.material = material;</span>
<span class="cstat-no" title="statement not covered" >            if (material instanceof StandardMaterial) {</span>
<span class="cstat-no" title="statement not covered" >                material.jointCount = jointIndices.length;</span>
            }
            else {
<span class="cstat-no" title="statement not covered" >                material.shader = shaderLib.get(</span>
                    shaderName, {
...
<span class="cstat-no" title="statement not covered" >            material = new StandardMaterial({</span>
            ...
            var fragmentDefines = <span class="cstat-no" title="statement not covered" >{</span>
                USE_ROUGHNESS: null,
                USE_METALNESS: null
            };
<span class="cstat-no" title="statement not covered" >            if (materialInfo.doubleSided) {</span>
<span class="cstat-no" title="statement not covered" >                fragmentDefines.DOUBLE_SIDED = null;</span>
            }
...
<span class="cstat-no" title="statement not covered" >                fragmentDefines.ALPHA_TEST = null;</span>
            }
<span class="cstat-no" title="statement not covered" >            if (materialInfo.doubleSided) {</span>
<span class="cstat-no" title="statement not covered" >                fragmentDefines.DOUBLE_SIDED = null;</span>
            }
...
<span class="cstat-no" title="statement not covered" >                            node.add(instanceMesh(primitives[j]));</span>
                        }
                    }
                }
            }
...
<span class="cstat-no" title="statement not covered" >                clip.addTrack(tracks[hash]);</span>
            }
<span class="cstat-no" title="statement not covered" >            clip.calcLifeFromTracks();</span>
