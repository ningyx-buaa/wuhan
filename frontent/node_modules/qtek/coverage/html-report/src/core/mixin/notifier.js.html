...
<span class="cstat-no" title="statement not covered" >                return;</span>
            case 4:
                ...
                return;
<span class="branch-4 cbranch-no" title="branch not covered" >            case 5:</span>
<span class="cstat-no" title="statement not covered" >                while (++i &lt; l) {</span>
<span class="cstat-no" title="statement not covered" >                    hdls[i].action.call(hdls[i].context, args[1], args[2], args[3], args[4]);</span>
                }
<span class="cstat-no" title="statement not covered" >                return;</span>
