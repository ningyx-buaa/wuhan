  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">6.73% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>7/104</span>
      </div>
      <div class='fl pad1y space-right2'>
...
<span class="cstat-no" title="statement not covered" >    return /** @lends qtek.Skeleton# */{</span>
&nbsp;
        /**
...
<span class="cstat-no" title="statement not covered" >            for (var i = 0; i &lt; this.joints.length; i++) {</span>
                ...
                // }
                // else {
<span class="cstat-no" title="statement not covered" >                    mat4.copy(m4, joint.node.worldTransform._array);</span>
...
&nbsp;
     ...
     */
    setPose: function (clipIndex) <span class="fstat-no" title="function not covered" >{</span>
<span class="cstat-no" title="statement not covered" >        if (this._clips[clipIndex]) {</span>
            var clip = <span class="cstat-no" title="statement not covered" >this._clips[clipIndex].clip;</span>
            var maps = <span class="cstat-no" title="statement not covered" >this._clips[clipIndex].maps;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            for (var i = 0; i &lt; this.joints.length; i++) {</span>
                var joint = <span class="cstat-no" title="statement not covered" >this.joints[i];</span>
...
<span class="cstat-no" title="statement not covered" >                    vec3.copy(joint.node.position._array, pose.position);</span>
                }
<span class="cstat-no" title="statement not covered" >                if (pose.channels.rotation) {</span>
<span class="cstat-no" title="statement not covered" >                    quat.copy(joint.node.rotation._array, pose.rotation);</span>
                }
<span class="cstat-no" title="statement not covered" >                if (pose.channels.scale) {</span>
<span class="cstat-no" title="statement not covered" >                    vec3.copy(joint.node.scale._array, pose.scale);</span>
                }
&nbsp;
...
&nbsp;
    clone: function (rootNode, newRootNode) <span class="fstat-no" title="function not covered" >{</span>
...
<span class="cstat-no" title="statement not covered" >            newJoint.name = this.joints[i].name;</span>
<span class="cstat-no" title="statement not covered" >            newJoint.index = this.joints[i].index;</span>
&nbsp;
            var path = <span class="cstat-no" title="statement not covered" >this.joints[i].node.getPath(rootNode);</span>
            var rootNodePath = <span class="cstat-no" title="statement not covered" >this.joints[i].rootNode.getPath(rootNode);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (path != null &amp;&amp; rootNodePath != null) {</span>
<span class="cstat-no" title="statement not covered" >                newJoint.node = newRootNode.queryNode(path);</span>
            }
            else {
                // PENDING
<span class="cstat-no" title="statement not covered" >                console.warn('Something wrong in clone, may be the skeleton root nodes is not mounted on the cloned root node.')</span>
            }
