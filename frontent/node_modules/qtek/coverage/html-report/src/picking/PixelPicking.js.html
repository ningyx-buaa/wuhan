...
<span class="cstat-no" title="statement not covered" >    return /** @lends qtek.picking.PixelPicking# */ {</span>
        /**
         * Target renderer
         * @type {qtek.Renderer}
         */
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        this._shader = new Shader({</span>
...
<span class="cstat-no" title="statement not covered" >        this._shader.dispose(renderer);</span>
    }
});
&nbsp;
