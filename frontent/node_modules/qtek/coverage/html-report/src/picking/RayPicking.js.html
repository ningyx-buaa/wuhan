...
<span class="cstat-no" title="statement not covered" >            if (isSkinnedMesh) {</span>
<span class="cstat-no" title="statement not covered" >                skinMatricesArray = renderable.skeleton.getSubSkinMatrices(renderable.__GUID__, renderable.joints);</span>
...
<span class="cstat-no" title="statement not covered" >            for (var i = 0; i &lt; indices.length; i += 3) {</span>
                ...
                var finalPosAttr = <span class="cstat-no" title="statement not covered" >isSkinnedMesh</span>
                    ...
                    : positionAttr;
<span class="cstat-no" title="statement not covered" >                finalPosAttr.get(i1, v1._array);</span>
<span class="cstat-no" title="statement not covered" >                finalPosAttr.get(i2, v2._array);</span>
<span class="cstat-no" title="statement not covered" >                finalPosAttr.get(i3, v3._array);</span>
&nbsp;
