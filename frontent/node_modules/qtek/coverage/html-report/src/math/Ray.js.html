...
&nbsp;
    ...
    intersectPlane: function (plane, out) <span class="fstat-no" title="function not covered" >{</span>
        var pn = <span class="cstat-no" title="statement not covered" >plane.normal._array;</span>
        var d = <span class="cstat-no" title="statement not covered" >plane.distance;</span>
        var ro = <span class="cstat-no" title="statement not covered" >this.origin._array;</span>
        var rd = <span class="cstat-no" title="statement not covered" >this.direction._array;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        vec3.scaleAndAdd(out._array, ro, rd, -t);</span>
...
&nbsp;
    ...
    mirrorAgainstPlane: function (plane) <span class="fstat-no" title="function not covered" >{</span>
        // Distance to plane
        var d = <span class="cstat-no" title="statement not covered" >vec3.dot(plane.normal._array, this.direction._array);</span>
<span class="cstat-no" title="statement not covered" >        vec3.scaleAndAdd(this.direction._array, this.direction._array, plane.normal._array, -d * 2);</span>
...
<span class="cstat-no" title="statement not covered" >            vec3.sub(v, point, this.origin._array);</span>
            // Distance from projection point to origin
            var b = <span class="cstat-no" title="statement not covered" >vec3.dot(v, this.direction._array);</span>
<span class="cstat-no" title="statement not covered" >            if (b &lt; 0) {</span>
<span class="cstat-no" title="statement not covered" >                return vec3.distance(this.origin._array, point);</span>
            }
...
&nbsp;
    ...
    intersectSphere: (function () {
        ...
        return function (center, radius, out) <span class="fstat-no" title="function not covered" >{</span>
            var origin = <span class="cstat-no" title="statement not covered" >this.origin._array;</span>
            var direction = <span class="cstat-no" title="statement not covered" >this.direction._array;</span>
<span class="cstat-no" title="statement not covered" >            center = center._array;</span>
...
<span class="cstat-no" title="statement not covered" >                    vec3.scaleAndAdd(out._array, origin, direction, t1);</span>
<span class="cstat-no" title="statement not covered" >                    return out;</span>
                }
            }
            else {
<span class="cstat-no" title="statement not covered" >                vec3.scaleAndAdd(out._array, origin, direction, t0);</span>
<span class="cstat-no" title="statement not covered" >                return out;</span>
            }
        };
    })(),
&nbsp;
    ...
    intersectBoundingBox: function (bbox, out) <span class="fstat-no" title="function not covered" >{</span>
        var dir = <span class="cstat-no" title="statement not covered" >this.direction._array;</span>
        var origin = <span class="cstat-no" title="statement not covered" >this.origin._array;</span>
        var min = <span class="cstat-no" title="statement not covered" >bbox.min._array;</span>
        var max = <span class="cstat-no" title="statement not covered" >bbox.max._array;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        vec3.scaleAndAdd(out._array, origin, dir, t);</span>
<span class="cstat-no" title="statement not covered" >        return out;</span>
    },
&nbsp;
...
&nbsp;
        return function (a, b, c, singleSided, out, barycenteric) <span class="fstat-no" title="function not covered" >{</span>
            var dir = <span class="cstat-no" title="statement not covered" >this.direction._array;</span>
            var origin = <span class="cstat-no" title="statement not covered" >this.origin._array;</span>
<span class="cstat-no" title="statement not covered" >            a = a._array;</span>
<span class="cstat-no" title="statement not covered" >            b = b._array;</span>
<span class="cstat-no" title="statement not covered" >            c = c._array;</span>
&nbsp;
