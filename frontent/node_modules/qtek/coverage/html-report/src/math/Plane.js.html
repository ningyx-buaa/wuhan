...
<span class="cstat-no" title="statement not covered" >        return vec3.dot(point._array, this.normal._array) - this.distance;</span>
    },
&nbsp;
    /**
...
<span class="cstat-no" title="statement not covered" >        vec3.scaleAndAdd(out._array, point._array, this.normal._array, -d);</span>
...
&nbsp;
    ...
    intersectFrustum: function(frustum) <span class="fstat-no" title="function not covered" >{</span>
        ...
        var normal = <span class="cstat-no" title="statement not covered" >this.normal._array;</span>
        var onPlane = <span class="cstat-no" title="statement not covered" >vec3.dot(coords[0]._array, normal) &gt; this.distance;</span>
<span class="cstat-no" title="statement not covered" >        for (var i = 1; i &lt; 8; i++) {</span>
<span class="cstat-no" title="statement not covered" >            if ((vec3.dot(coords[i]._array, normal) &gt; this.distance) != onPlane) {</span>
...
<span class="cstat-no" title="statement not covered" >                return null;</span>
            ...
            // Ray intersection
            var pn = <span class="cstat-no" title="statement not covered" >this.normal._array;</span>
            var d = <span class="cstat-no" title="statement not covered" >this.distance;</span>
            var ro = <span class="cstat-no" title="statement not covered" >start._array;</span>
            // direction
<span class="cstat-no" title="statement not covered" >            vec3.sub(rd, end._array, start._array);</span>
...
<span class="cstat-no" title="statement not covered" >            m4 = m4._array;</span>
            // Transform point on plane
<span class="cstat-no" title="statement not covered" >            vec3.scale(pointv4, this.normal._array, this.distance);</span>
<span class="cstat-no" title="statement not covered" >            vec4.transformMat4(pointv4, pointv4, m4);</span>
<span class="cstat-no" title="statement not covered" >            this.distance = vec3.dot(pointv4, this.normal._array);</span>
...
<span class="cstat-no" title="statement not covered" >            vec3.copy(normalv4, this.normal._array);</span>
<span class="cstat-no" title="statement not covered" >            vec4.transformMat4(normalv4, normalv4, inverseTranspose);</span>
<span class="cstat-no" title="statement not covered" >            vec3.copy(this.normal._array, normalv4);</span>
        };
    })(),
&nbsp;
    /**
...
<span class="cstat-no" title="statement not covered" >        vec3.copy(this.normal._array, plane.normal._array);</span>
