  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>104/156</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>92/138</span>
      </div>
    </div>
  </div>
...
297
298
299</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cstat-no" title="statement not covered" >        if (vertices.length &gt; 0) {</span>
            ...
            var minArr = <span class="cstat-no" title="statement not covered" >min._array;</span>
            var maxArr = <span class="cstat-no" title="statement not covered" >max._array;</span>
...
&nbsp;
        var _min = <span class="cstat-no" title="statement not covered" >this.min._array;</span>
        var _max = <span class="cstat-no" title="statement not covered" >this.max._array;</span>
&nbsp;
        var _min2 = <span class="cstat-no" title="statement not covered" >bbox.min._array;</span>
        var _max2 = <span class="cstat-no" title="statement not covered" >bbox.max._array;</span>
&nbsp;
...
&nbsp;
    ...
    containPoint: function (p) <span class="fstat-no" title="function not covered" >{</span>
        ...
        var _max = <span class="cstat-no" title="statement not covered" >this.max._array;</span>
&nbsp;
        var _p = <span class="cstat-no" title="statement not covered" >p._array;</span>
&nbsp;
...
&nbsp;
    updateVertices: function () <span class="fstat-no" title="function not covered" >{</span>
        var vertices = <span class="cstat-no" title="statement not covered" >this.vertices;</span>
<span class="cstat-no" title="statement not covered" >        if (!vertices) {</span>
            // Cube vertices
            var vertices = <span class="cstat-no" title="statement not covered" >[];</span>
<span class="cstat-no" title="statement not covered" >            for (var i = 0; i &lt; 8; i++) {</span>
<span class="cstat-no" title="statement not covered" >                vertices[i] = vec3.fromValues(0, 0, 0);</span>
            }
&nbsp;
            /**
             ...
             * @type {Float32Array[]}
             */
<span class="cstat-no" title="statement not covered" >            this.vertices = vertices;</span>
        }
        var min = <span class="cstat-no" title="statement not covered" >this.min._array;</span>
        var max = <span class="cstat-no" title="statement not covered" >this.max._array;</span>
        //--- min z
        // min x
<span class="cstat-no" title="statement not covered" >        vec3Set(vertices[0], min[0], min[1], min[2]);</span>
<span class="cstat-no" title="statement not covered" >        vec3Set(vertices[1], min[0], max[1], min[2]);</span>
        // max x
<span class="cstat-no" title="statement not covered" >        vec3Set(vertices[2], max[0], min[1], min[2]);</span>
<span class="cstat-no" title="statement not covered" >        vec3Set(vertices[3], max[0], max[1], min[2]);</span>
&nbsp;
        //-- max z
<span class="cstat-no" title="statement not covered" >        vec3Set(vertices[4], min[0], min[1], max[2]);</span>
<span class="cstat-no" title="statement not covered" >        vec3Set(vertices[5], min[0], max[1], max[2]);</span>
<span class="cstat-no" title="statement not covered" >        vec3Set(vertices[6], max[0], min[1], max[2]);</span>
<span class="cstat-no" title="statement not covered" >        vec3Set(vertices[7], max[0], max[1], max[2]);</span>
&nbsp;
