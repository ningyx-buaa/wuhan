...
<span class="cstat-no" title="statement not covered" >            positionAttr.set(i, coords[idx]._array);</span>
<span class="cstat-no" title="statement not covered" >            normalAttr.set(i, this.plane.normal._array);</span>
...
<span class="cstat-no" title="statement not covered" >                start._array = frustumVertices[lines[i * 2]];</span>
<span class="cstat-no" title="statement not covered" >                end._array = frustumVertices[lines[i * 2 + 1]];</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                points[i].applyProjection(this.camera.projectionMatrix);</span>
            ...
            var minX = <span class="cstat-no" title="statement not covered" >points[0]._array[0];</span>
            var minY = <span class="cstat-no" title="statement not covered" >points[0]._array[1];</span>
            var maxX = <span class="cstat-no" title="statement not covered" >points[0]._array[0];</span>
            var maxY = <span class="cstat-no" title="statement not covered" >points[0]._array[1];</span>
<span class="cstat-no" title="statement not covered" >            for (var i = 1; i &lt; nPoints; i++) {</span>
<span class="cstat-no" title="statement not covered" >                maxX = Math.max(maxX, points[i]._array[0]);</span>
<span class="cstat-no" title="statement not covered" >                maxY = Math.max(maxY, points[i]._array[1]);</span>
<span class="cstat-no" title="statement not covered" >                minX = Math.min(minX, points[i]._array[0]);</span>
<span class="cstat-no" title="statement not covered" >                minY = Math.min(minY, points[i]._array[1]);</span>
            }
<span class="cstat-no" title="statement not covered" >            if (minX == maxX || minY == maxY) {</span>
<span class="cstat-no" title="statement not covered" >                return;</span>
            }
<span class="cstat-no" title="statement not covered" >            coords[0]._array[0] = minX;</span>
<span class="cstat-no" title="statement not covered" >            coords[0]._array[1] = minY;</span>
<span class="cstat-no" title="statement not covered" >            coords[1]._array[0] = minX;</span>
<span class="cstat-no" title="statement not covered" >            coords[1]._array[1] = maxY;</span>
<span class="cstat-no" title="statement not covered" >            coords[2]._array[0] = maxX;</span>
<span class="cstat-no" title="statement not covered" >            coords[2]._array[1] = maxY;</span>
<span class="cstat-no" title="statement not covered" >            coords[3]._array[0] = maxX;</span>
<span class="cstat-no" title="statement not covered" >            coords[3]._array[1] = minY;</span>
&nbsp;
