...
<html lang="en">
<head>
    <title>Code coverage report for src/plugin/FirstPersonControl.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/plugin/</a> FirstPersonControl.js
    </h1>
    <div class='clearfix'>
 ...
 *     });
 */
var FirstPersonControl = Base.extend(function() <span class="fstat-no" title="function not covered" >{</span>
<span class="cstat-no" title="statement not covered" >    return /** @lends qtek.plugin.FirstPersonControl# */ {</span>
        /**
