  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">1.23% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>3/243</span>
      </div>
      <div class='fl pad1y space-right2'>
...
705
706
707</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cstat-no" title="statement not covered" >            this.animation.on('frame', this.update);</span>
        }
    },
&nbsp;
    /**
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (this.animation) {</span>
<span class="cstat-no" title="statement not covered" >            this.animation.off('frame', this.update);</span>
        }
...
&nbsp;
        ...
        var animation = <span class="cstat-no" title="statement not covered" >this.animation;</span>
<span class="cstat-no" title="statement not covered" >        if (!animation) {</span>
<span class="cstat-no" title="statement not covered" >            return;</span>
        }
<span class="cstat-no" title="statement not covered" >        if (opts.distance != null) {</span>
...
&nbsp;
        ...
        var euler = <span class="cstat-no" title="statement not covered" >new Vector3();</span>
<span class="cstat-no" title="statement not covered" >        euler.eulerFromQuat(</span>
            this.target.rotation.normalize(), 'ZYX'
        );
&nbsp;
<span class="cstat-no" title="statement not covered" >        this._theta = -euler.x;</span>
<span class="cstat-no" title="statement not covered" >        this._phi = -euler.y;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        this.setBeta(this.getBeta());</span>
<span class="cstat-no" title="statement not covered" >        this.setAlpha(this.getAlpha());</span>
&nbsp;
