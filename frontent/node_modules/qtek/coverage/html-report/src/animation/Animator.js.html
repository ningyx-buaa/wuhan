...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (easing &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >easing !== 'spline')</span> {
<span class="cstat-no" title="statement not covered" >        clip.setEasing(easing);</span>
    }
&nbsp;
    return clip;
}
