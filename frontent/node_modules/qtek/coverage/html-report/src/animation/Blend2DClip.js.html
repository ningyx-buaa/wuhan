...
<span class="cstat-no" title="statement not covered" >    this._triangles = delaunay.triangulate(inputs, '_array');</span>
};
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    if (this._cacheTriangle) {</span>
        var res = <span class="cstat-no" title="statement not covered" >delaunay.contains(this._cacheTriangle.vertices, position._array);</span>
<span class="cstat-no" title="statement not covered" >        if (res) {</span>
...
<span class="cstat-no" title="statement not covered" >    for (var i = 0; i &lt; this._triangles.length; i++) {</span>
        ...
        var res = <span class="cstat-no" title="statement not covered" >delaunay.contains(tri.vertices, this.position._array);</span>
<span class="cstat-no" title="statement not covered" >        if (res) {</span>
