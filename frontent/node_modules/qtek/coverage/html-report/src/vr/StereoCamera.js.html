...
&nbsp;
        // translate xOffset
<span class="cstat-no" title="statement not covered" >        this._eyeLeft._array[12] = - eyeSep;</span>
<span class="cstat-no" title="statement not covered" >        this._eyeRight._array[12] = eyeSep;</span>
&nbsp;
        // for left eye
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        tmpProjectionMatrix._array[0] = 2 * near / (xmax - xmin);</span>
<span class="cstat-no" title="statement not covered" >        tmpProjectionMatrix._array[8] = (xmax + xmin ) / (xmax - xmin);</span>
&nbsp;
